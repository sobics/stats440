...
A one unit increase in the blotted uterus weight of a rat in Lab ChungKorea, Protocol B leads to a `r 100*e^(.094434)-1`% increase in the blotted uterus weight of a rat in Lab Basf, Protocol A.
\newline
A one unit increase in the blotted uterus weight of a rat in Lab ChungKorea, Protocol B leads to a `r 100*e^(-0.018317)-1`% increase in the blotted uterus weight of a rat in Lab Basf, Protocol A.
\newline
A one unit increase in the blotted uterus weight of a rat in Lab ChungKorea, Protocol B leads to a `r 100*e^(0.167783)-1`% increase in the blotted uterus weight of a rat in Lab Basf, Protocol A.
\newline
A one unit increase in the blotted uterus weight of a rat in Lab ChungKorea, Protocol B leads to a `r 100*e^(0.042518)-1`% increase in the blotted uterus weight of a rat in Lab Basf, Protocol A.
\newline
A one unit increase in the blotted uterus weight of a rat in Lab ChungKorea, Protocol B leads to a `r 100*(e^(0.297668)-1)`% increase in the blotted uterus weight of a rat in Lab Basf, Protocol A.
