...
#Recommendations
Due to the variability between labs, perhaps not all labs and protocols are comparable. For this, we recommend that this assay would be best conducted in one lab and one protocol to ensure consistency in the results. 
=======
...
>>>>>>> a1c90b6e90606dafc1332b746083a1b4647c9230
```{r}
```
