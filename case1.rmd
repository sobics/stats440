...
```
The Minimum Model performs better than our Proposed Model, with an average RMSE of `r mean(R3)` after 100 iterations, which is `r mean(R2)-mean(R3)` lower than our Proposed Model. 
