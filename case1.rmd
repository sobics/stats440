...
ggplot(data = mean_dat1, aes(x = dose1, y = wblot, color = lab)) + geom_line() + ggtitle("Dose 1")
mean_dat2 <- dat %>% group_by(lab, dose2) %>% summarise(wblot = mean(wblot))
ggplot(data = mean_dat2, aes(x = dose2, y = wblot, color = lab)) + geom_line() + ggtitle('Dose 2')
