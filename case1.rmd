...
```
Based on our intuitive assumptions from Case Study 1, above is our proposed model from write-up 1. However, we were informed by a more experienced Statistician (our TA) about the necessity to model the data with a minimum equation of:
