...
```
After exploring and comparing multiple models, we noticed that adding dose1 and dose2 as both fixed and random effects better fit the data. The random effect captures the variation in the effects of dose1 and dose2 between labs, and the fixed effect captures the population effects of dose1 and dose2 across all labs. Across all labs, we also assumed there were interactions between the population protocol and lab, so we  
