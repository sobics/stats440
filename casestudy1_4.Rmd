...
m2 <- lmer(log(blot + 1) ~ (1 + proto|lab) + kern_distribution(dose1, blot, knots = 2, s = 1) + kern_distribution(dose2, blot, knots = 3, s = 1) + kern_distribution(body, blot, knots = 2, s = 1), data = dat) #X + Z + R + S + random effect
summary(m2)
